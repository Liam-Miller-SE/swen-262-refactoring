...
public class Facade extends Component {
    ...
    private Point startSpace = null; // Starting space for current move
    private Point endSpace   = null; // Ending space for current move
     ...
     */
    public void selectSpace( Point space ){
	...
	}else if( startSpace != null && endSpace == null ){
	    if( space == startSpace ){
